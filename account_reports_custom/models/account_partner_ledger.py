            ...
            for column_group_key in options['column_groups']:
                ...
                if partner:
                    ...
                    if 'balance' in initial_balance[partner.id][column_group_key]:
                        ...
                        partner_values[column_group_key]['debit'] = partner_sum.get('debit', 0.0) - initial_balance[partner.id][column_group_key]['balance'] - partner_values[column_group_key]['balance']
                        partner_values[column_group_key]['credit'] = partner_sum.get('credit', 0.0) - partner_values[column_group_key]['balance']
